<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SignUpPage.aspx.cs" Inherits="CabHireProject.Pages.SignUpPage" ValidateRequest="false" %>
                ...
                <div class="col-md-10 col-md-offset-1">
                    ...
                    <div class="col-md-10 col-md-offset-1 ">
                        <div class="btn-group btn-group-justified cntr" role="group" aria-label="Dobtn">
                            <div class="btn-group cntr" role="group">
                    ...
                    <div class="col-md-12 text-center">
                        <br />
                    <br />
                    <asp:Label ID="Label10" runat="server" Text="" ForeColor="#ff6666" Font-Size="18px" ></asp:Label>
                    </div>
           <%--         <div class="col-md-12">
                        <br />
                        <br />
